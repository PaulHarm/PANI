...
- `assets/home.css`: ausschließlich für die beiden Startseiten. Native Radiofelder steuern über CSS `:has()` die Gebäudehervorhebung und den zugehörigen Kurztext auch ohne JavaScript. Die Fenster leuchten in 1,3 Sekunden mit bis zu 480 Millisekunden Versatz auf und blenden beim Abwählen ohne Verzögerung in 420 Millisekunden ab. Die einzelnen SVG-Fenster erben die animierte Farbe ihres `use`-Elements. WEG beleuchtet Eingang und Treppenhaus, Miethaus alle Fenster, Sondereigentum nur die ausgewählte Wohnung. Bei reduzierter Bewegung wechseln die Farben unmittelbar. Mobil steht die Auswahl oberhalb des Hauses. Ohne `:has()` bleiben alle Leistungstexte und Links sichtbar.
- `leistungen.html` und `en-services.html`: Leistungsübersicht mit einer animierten vierstufigen Wegführung, einer klickbaren Slideshow für besondere Anforderungen sowie den Weiterentwicklungsangeboten energetische Sanierung und Baubetreuung. Echte Baustellenfotos und Links führen zu den Detailseiten. Hauptnavigation, mobiles Menü, Footer und Brotkrumennavigation führen zur Übersicht.
...
Für die beiden Weiterentwicklungsangebote liegen zwei lokale Baustellenfotos im Repository: `sanierung-baustelle.jpg` stammt von Andrew Dunn und ist auf [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:BuildingSite.jpg) unter [CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/) veröffentlicht; `baubetreuung-baustelle.jpg` zeigt eine Backsteinreparatur von David E. Lucas, bereitgestellt über die Columbus Metropolitan Library / DPLA und auf [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Brickwork_renovation_-_DPLA_-_9e450b5aad67bc2b358d0b20ea59f8fc.jpg) als Public Domain (US) ausgewiesen.
